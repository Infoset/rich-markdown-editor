...
export declare type Props = {
    ...
    disableExtensions?: ('strong' | 'code_inline' | 'highlight' | 'em' | 'link' | 'placeholder' | 'strikethrough' | 'underline' | 'blockquote' | 'bullet_list' | 'checkbox_item' | 'checkbox_list' | 'code_block' | 'code_fence' | 'embed' | 'br' | 'heading' | 'hr' | 'image' | 'list_item' | 'container_notice' | 'ordered_list' | 'paragraph' | 'table' | 'table_of_contents' | 'td' | 'th' | 'tr' | 'emoji')[];
    autoFocus?: boolean;
    readOnly?: boolean;
